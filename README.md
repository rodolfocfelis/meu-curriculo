...
Para a construção desta página, foquei em uma estrutura semântica e estilização moderna:

* **HTML5:** Estruturação de conteúdo.
* **CSS3:** Layout (Flexbox/Grid) e estilização personalizada.
...
- **Backend & DB:** Node.js, PostgreSQL, APIs REST
- **Cloud & DevOps:** Azure, Git/GitHub, Scrum
